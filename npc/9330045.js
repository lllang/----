...
function action(mode, type, selection) {
	...
	//cm.sendSimple("你想要做什么？\n\r #b#L0#进入钓鱼场#l \n\r #L1#买鱼饵#l \n\r #L2#买钓鱼椅#l \n\r #L3#用美味的饵可以#l \n\r #L4#钓鱼指南#l \n\r #L5##i1142146:#贸易500金蛋（渔王勋章[期：30天]）#l");
            ...
            text += "你好！钓鱼请购买钓鱼椅#v3010184#钓鱼杆#v5340001#还有鱼饵#v2300000#好了介绍这么多，加油！\r\n"//3
			//text += "#v5021007#你好！钓鱼请购买钓鱼椅#v3010184#k！#v5021007#\r\n\r\n"//3
            text += "#L5##v4031636##v4031640#    →  #r钓鱼兑换中心#k  ←   #v4031644##v4031648##l\r\n"//3
            text += "#L2##v3010184# 5000点券（24小时）  #l"//3
            text += "#L3##v5340001# 2000点券（12小时）#l\r\n"//3
            text += "#L6##v2300000# 5000W鱼饵（1000个）#l"//3
            text += "#L4##v2300001# 10000点券（1000个）#l\r\n"//3
           // text += "#L4##v2300001# 2000点券（100个）\r\n\r\n#l"//3
            
			text += "#L1##r#e进入1线自由市场即可钓鱼#k#l\r\n\r\n"//3
      ...
      /*      text += "#v5021007##v5021007##v5021007##v5021007##v5021007##v5021007##v5021007##v5021007##v5021007#\r\n"//3
            ...
            text += "#L10##v3010184##v5340001##v2300001#领取。#l\r\n"//3
	...
	if (sel == 0) {
     ...
     if (cm.getBossLog('钓鱼大赛') == 1) {
		...
		if (cm.haveItem(3010184)) {
		cm.sendOk("你已经有一把钓鱼椅。每个角色只能有1个钓鱼椅。");
	    } else {
		    cm.gainItem(3010184, 1, 1);
		...
		cm.sendOk("你已经有一把钓鱼椅。每个角色只能有1个钓鱼椅。");
		  ...
		  if (cm.getLevel() > 49){
				if (cm.canHold(3010184) && cm.getPlayer().getCSPoints(1) >= 5000) {
		    cm.gainNX(-5000);
		    cm.gainItem(3010184, 1, 24);
		    cm.sendOk("祝你快乐钓鱼！");
		    cm.dispose();
				} else {
		...
		if (cm.canHold(2300001) && cm.getMeso() >= 50000000) {
