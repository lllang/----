...
function action(mode, type, selection) {
	...
	if (selection == 0) { // How do I move?
	    ...
	    status = -1;
	    cm.sendNext("金币是在勇闯冒险岛使用的货币。你可以通过它们来购买物品。为了获取它们，你必须杀死大量的怪物，从它们身上获取金币。也可以在商店出售一些垃圾的装备物品等，或完成任务，来获取金币");
	}
	...
	cm.sendNext("想知道这个岛吗？他叫勇闯冒险岛，漂浮在空中，他一直漂浮在天空中，所以那些讨厌的怪物，并不是真的存在。这是一个非常安静的岛，适合初学者!");
