...
text += "  #L1#挑战藏宝阁#k>>>>>>>     需要#v 2041213#100个#l\r\n\r\n";
text += "    #b挑战时间#b#r>>>>>> 需要200级 时间40秒钟\r\n\r\n";
text += "    #b奖励：#b #v 2049323# #v 2533000# #v 2613008# #v 2049600# #v 2531000# #v 4002001# #v 2614001# #v 2614000# #v 2610003# #v 2610001#\r\n\r\n";
text += "   "+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"		 
cm.sendSimple(text);  
}  else if (selection == 1) { 
            if(cm.haveItem(2041213,100) && cm.getPlayerCount(921100300) == 0){
			cm.getMap(921100300).resetFully();
			cm.gainItem(2041213,-100); 
		    cm.warpBack(921100300,910000015,43);
			//cm.spawnMobOnMap(2400020, 1, 25, 201, 970000004, 35000000);
			cm.sendOk("你有5分钟的时间。");
			cm.喇叭(2, "彩虹岛[" + cm.getPlayer().getName() + "]挑战藏宝阁40秒钟，祝他满载而归！");
			cm.dispose();
			}else{
