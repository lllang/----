...
function getPrize(eim,cm) {
    ...
    cm.gainItem(itemSet[sel], qty);
		//cm.setBossLog("废弃组队次数");
                //cm.gainItem(4250602,1);//兵法
		/*cm.gainItem(4002000, 1);
		cm.gainItem(4031456, 4);
		cm.gainItem(4170011, 1);
		cm.gainItem(4250602, 2);
		cm.gainItem(4002001, 1);*/
		cm.getPlayer().setBossLog("废弃组队",0);
		cm.gainItem(4170002, 1);
		cm.removeAll(4001022);  //清楚物品所有数目
		cm.removeAll(4001156);  //清楚物品所有数目4001008
		cm.removeAll(4001008);  //清楚物品所有数目
		cm.removeAll(4001007);  //清楚物品所有数目
