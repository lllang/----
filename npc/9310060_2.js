...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "\t\t\t完成任务奖励如下：#k#n\r\n"
			text += "#v2049323#[5]个  #v2614000#[2]个  #v2041332#[2]个 #v2533000#[1]个#k#n\r\n"
			text += "#v2613008#[1]个  #v4031250#[10]个  #v2047926#[2]个 #v2140002#5000万#k#n\r\n\r\n"
			text += "\t\t\t当前任务情况如下：#k#n\r\n"
			...
			text += "#r天空副本："+cm.getPlayer().getBossLog("天空组队",0)+"/0  海盗组队："+cm.getPlayer().getBossLog("海盗组队",0)+"/2#k#n\r\n\r\n"
			...
			if (cm.getPlayer().getBossLog("月妙组队",0) < 2){
				...
				cm.dispose();
			} else if (cm.getPlayer().getBossLog("天空组队",0) < 0){
