...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			textz += "#v2614001#*4，#v4002001#*4，#v1122017#*1天，#v2049600#*8 #v2041332#*12 #v2613008#*8 #v2531000#*4";
			textz += "#v4170000#*40，#v2041213#*20，点券200000，抵用券100000\r\n";
			textz += "#b领取砖石VIP福利时请将#v3700090#放入背包内，#r并确保背包其他栏有空格#k、\r\n\r\n";
			cm.sendYesNo(textz);
			...
			if (cm.haveItem(3700090, 1) == false) {
				...
				cm.sendOk("领取成功");
				cm.喇叭(1,"["+cm.getName()+"]玩家成功领取钻石VIP升级加强版奖励，获得大量奖励！");
				cm.dispose();
			}
