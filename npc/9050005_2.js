...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L0#" + 蓝色角点 + "制作#i4310034#(#r正义币1个#k),需要#i4000176#,#i4000040# #i4001318# #i4000175#  #i4310038#  #l\r\n";
            ...
            if (selection == 0) {
                if (cm.haveItem(4000176, 1) == false) {
                    cm.sendOk("所需#i4000176#道具不足。");
                    cm.dispose();
                } else if (cm.haveItem(4000040, 1) == false) {
                    cm.sendOk("所需#i4000040#道具不足。");
                    cm.dispose();
				 } else if (cm.haveItem(4001318, 1) == false) {
                    cm.sendOk("所需#i4001318#道具不足。");
                    cm.dispose();
				 } else if (cm.haveItem(4000175, 1) == false) {
                    cm.sendOk("所需#i4000175#道具不足。");
                    cm.dispose();
				 } else if (cm.haveItem(4310038, 1) == false) {
                    cm.sendOk("所需#i4310038#道具不足。");
                    cm.dispose();
                } else {
                    ...
                    cm.sendOk("兑换成功。");
					cm.喇叭(2, "恭喜[" + cm.getPlayer().getName() + "]成功兑换了1个快去增加100强化以上的道具吧！！");
                    cm.dispose();
                }
