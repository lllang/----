...
text += "  #L1#挑战封号斗罗称号  #k>>>>>>>        需要#v 4001028##l\r\n\r\n";
text += "    #b挑战条件#b#r>>>>>> 需要150级  推荐输出伤害值2688-3288万#k\r\n\r\n";
text += "    #b挑战胜利可兑换#b#r>>>>>> #v 1142802# 全属性+150称号#k\r\n\r\n";
text += "   "+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"		 
cm.sendSimple(text);  
}  else if (selection == 1) { 
			...
			cm.spawnMobOnMap(8220013, 1, 277, 201, 970000004, 85000000000);
			cm.sendOk("你有5分钟的时间。");
			cm.喇叭(2, "彩虹岛[" + cm.getPlayer().getName() + "]挑战封号斗罗称号限时5分钟祝他成功！");
			cm.dispose();
			}else{
