...
text += "#e#L0#"+正方箭头+"每日工资"+感叹号+"#l       #L1#"+正方箭头+"在线奖励"+感叹号+"#l\r\n\r\n"
text += "#e#L2#"+正方箭头+"签到兑换"+感叹号+"#l       #L3#"+正方箭头+"每日任务"+感叹号+"#l\r\n\r\n"
text += "#L4#"+正方箭头+"组队任务"+感叹号+"#l       #L5#"+正方箭头+"BOSS门票"+感叹号+"#l\r\n\r\n"
//text += "#L6#"+琴符+"绯红门票"+琴符+"#l       #L7#"+琴符+"普通门票"+琴符+"#l\r\n\r\n"
