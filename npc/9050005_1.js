...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L0#" + 蓝色角点 + "制作#i4032766#(#r黑币1个#k),需要#i4310086# 50个  #l\r\n";
            ...
            if (selection == 0) {
                if (cm.haveItem(4310086, 50) == false) {
                    cm.sendOk("所需#i4310086#道具不足。");
                    cm.dispose();
                } else {
					cm.gainItem(4310086, -50);
                    cm.gainItem(4032766, 1);
                    cm.sendOk("兑换成功。");
					cm.喇叭(2, "恭喜[" + cm.getPlayer().getName() + "]成功兑换了1个黑币，快去自由召唤福袋吧！！");
                    cm.dispose();
                }
