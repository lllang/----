...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            for (i = 0; i < 10; i++) {
                text += "我这里是黑龙之角中介！\r\n\r\n";
                text += "" + 红色箭头 + "#L1##b#e使用#v4031227# （五个）  兑换：黑龙之角#v4000186#=1个#l \r\n\r\n"//3
				text += "" + 红色箭头 + "#L2##b#e使用#v4031227# （五十个）兑换：黑龙之角#v4000186#=10个#l \r\n\r\n"//3
				text += "" + 红色箭头 + "#L3##b#e使用#v4031227# （五百个）兑换：黑龙之角#v4000186#=100个#l \r\n\r\n"//3
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功购买[角色位1个]");
            ...
            cm.dispose();
                ...
                cm.gainItem(4031227,-5);
				cm.gainItem(4000186,1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]使用五个赤珠兑换了一个黑龙之角~");
            cm.dispose();
			}else{
            cm.sendOk("赤珠不足无法换购！");
            cm.dispose();
                ...
                if (cm.haveItem(4031227,50)) {
                cm.gainItem(4031227,-50);
				cm.gainItem(4000186,10);
cm.喇叭(1, "[" + cm.getPlayer().getName() + "]使用五十个赤珠兑换了十个黑龙之角~~");
            cm.dispose();
			}else{
            cm.sendOk("赤珠不足无法换购！");
            cm.dispose();
                ...
                if (cm.haveItem(4031227,500)) {
                cm.gainItem(4031227,-500);
				cm.gainItem(4000186,100);
cm.喇叭(1, "[" + cm.getPlayer().getName() + "]使用五百个赤珠兑换了壹佰个黑龙之角~");
            cm.dispose();
			}else{
            cm.sendOk("赤珠不足无法换购！");
            cm.dispose();
