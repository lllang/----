...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			textz += "#v2614001#*1，#v4002001#*1，#v1122017#*1天，#v2049600#*2 #v2041332#*3 #v2613008#*2 #v2531000#*1";
			textz += "#v4170000#*10，点券50000，抵用券100000\r\n";
			textz += "#b领取砖石VIP福利时请将#v3700069#放入背包内，#r并确保背包其他栏有空格#k、\r\n\r\n";
			cm.sendYesNo(textz);
			...
			if (cm.haveItem(3700069, 1) == false) {
				...
				cm.sendOk("领取成功");
				cm.喇叭(1,"["+cm.getName()+"]玩家成功领取钻石VIP奖励，获得大量奖励！");
				cm.dispose();
			}
