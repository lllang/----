...
var itemList = 
Array(   
			Array(3990000,700,1,"炼制出1级次品法器"), //橙色蜡笔
			
			Array(3990001,250,1,"炼制出2级下品法器"), //蓝色蜡笔
			Array(3990001,250,1,"炼制出2级下品法器"), //蓝色蜡笔
			
			Array(3990002,120,1,"炼制出3级中品法器"), //绿色蜡笔
			Array(3990002,120,1,"炼制出3级中品法器"), //绿色蜡笔
			
			Array(3990003,80,1,"炼制出4级上品法器"), //紫色蜡笔
			
			Array(3990004,50,1,"炼制出5级极品法器")  //红色蜡笔
);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getAccountLog("杀怪点数",1) >= 20000 && cm.getPlayer().getMeso() >= 100000000) {
            cm.sendYesNo(""+个人情报+"\r\n\r\n"+圆形+" 消耗杀怪点数:[ #r"+cm.getPlayer().getAccountLog("杀怪点数",1)+"#k / #b20000#k ]\r\n"+圆形+" 消耗自身金币:[ #r"+cm.getPlayer().getMeso()+"#k / #b100000000#k ]\r\n\r\n"+感叹号+" 几率:#b#v 3990000# 40%#v 3990001# 12%#v 3990002# 9%#v 3990003# 6%#v 3990004# 3%#k\r\n"+感叹号+" 失败几率:#b30% #k失败不扣#b[杀怪点数]#k,但是会#b[炸炉]");
        } else {
