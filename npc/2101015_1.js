...
text += "  #L1#挑战魂士称号  #k>>>>>>>        需要#v 4001028##l\r\n\r\n";
text += "    #b挑战条件#b#r>>>>>> 需要50级 推荐输出伤害值5千-1万\r\n\r\n";
text += "    #b挑战胜利可兑换#b#r>>>>>> #v 1142499# 全属性+15称号#k\r\n\r\n";
text += "   "+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"		 
cm.sendSimple(text);  
}  else if (selection == 1) { 
			...
			cm.sendOk("你有5分钟的时间。");
			cm.喇叭(2, "彩虹岛[" + cm.getPlayer().getName() + "]挑战魂士称号限时5分钟祝他成功！");
			cm.dispose();
			}else{
			cm.sendOk("里面有人你也进不去");
			cm.dispose();
