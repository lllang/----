...
var status = 0;
	...
	if (status == 0) {
	    var textz = "#d我这里可以帮你制作120级武器\r\n#b需要本职业77武器+#v4001083##z4001083#+#v4001084##z4001084#+#v4001085##z4001085#+#v4000463##z4000463#*20+#v4031456##z4031456#*30+金币1500W    \r\n";
		...
		cm.sendSimple (textz);  
	       ...
	       if (selection == 1){
           	if (cm.getMeso() < 15000000) { 
				...
				cm.dispose();
			} else if (cm.itemQuantity(4000463) < 20 ) { 
				cm.sendOk("#b装备强化需要#v4000463#*50，您的物品不足#k");
				cm.dispose();
			} else if (cm.itemQuantity(4031456) < 30  ) { 
