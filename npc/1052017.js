...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L0#" + 蓝色角点 + "兑换#i1113037#(#r全属性+88#k),需要#i1112951#,#i1112952##l\r\n";

            text += "#L1#" + 蓝色角点 + "兑换#i1112793#(#r全属性+188#k),需要#i1112444#,#i1112915##l\r\n";
            ...
            if (selection == 0) {
                if (cm.haveItem(1112951, 1) == false) {
                    ...
                    cm.gainItem(1113037, 88, 88, 88, 88, 0, 0, 88, 88, 0, 0, 0, 0, 0, 0);
                    cm.sendOk("兑换成功。");
                    cm.dispose();
                }
                ...
                if (cm.haveItem(1112444, 1) == false) {
                    ...
                    cm.gainItem(1112793, 188, 188, 188, 188, 0, 0, 188, 188, 0, 0, 0, 0, 0, 0);
                    cm.sendOk("兑换成功。");
                    cm.dispose();
                }
