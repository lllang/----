...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			textz += "#v2614005#*1，#v4002001#*10，#v1122017#*1天，#v2049600#*15 #v2041332#*15 #v2613008#*15 #v2531000#*15";
			textz += "#v4170000#*80，#v2041213#*40，#v2041200#*2，点券400000，抵用券100000\r\n";
			textz += "#b领取砖石VIP福利时请将#v3700000#放入背包内，#r并确保背包其他栏有空格#k、\r\n\r\n";
			cm.sendYesNo(textz);
			...
			if (cm.haveItem(3700000, 1) == false) {
				...
				cm.gainItem(2614005, 1);
				cm.gainItem(2041213, 40);
				cm.gainItem(4002001, 10);
				cm.gainItem(2613008, 15);
				cm.gainItem(2049600, 15);
				cm.gainItem(2531000, 15);
				cm.gainItem(2041332, 15);
				cm.gainItem(4170000, 80);
