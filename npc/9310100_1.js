...
var itemId = 2614000;//消耗的道具
var num = 1;//消耗的道具num
var useitem = 2041214;//保护卷ID
var 破攻数 = 10000;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var selStr = "#r	破攻需要道具：#v" + itemId + "##b[" + num + "]#r个，请带来找我！#k\r\n";
			...
			selStr += "#r	基础成功率：#b百分99%#k\r\n";
			selStr += "#r	当前破功值：#b"+cm.getPlayer().getLimitBreak()+"#k\r\n";
			selStr += "#r	拥有破攻石：#b#c2614000#个#k\r\n";
			selStr += "#r	破功费用:#b3000W 加#v" + itemId + "##b#k\r\n";
		...
		if (sl == 0){
			...
			var text = "每一个#v" + useitem + "#可增加50点成功率。\r\n\r\n请输入你想消耗的#v" + useitem + "#数量\r\n\r\n";
