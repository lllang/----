...
text += "#L0#"+琴符+"副本装备"+琴符+"#l       #L1#"+琴符+"极品合成"+琴符+"#l\r\n\r\n"
text += "#L2#"+琴符+"勋章制作"+琴符+"#l       #L3#"+琴符+"翅膀制作"+琴符+"#l\r\n\r\n"
text += "#L4#"+琴符+"防具制作"+琴符+"#l       #L5#"+琴符+"饰品制作"+琴符+"#l\r\n\r\n"
text += "#L6#"+琴符+"血衣制作"+琴符+"#l       \r\n\r\n"
...
text += "   "+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+"\r\n"	
			...
			if (selection == 0) {
				cm.dispose();
				cm.openNpc(1002005, 1)
				
		   } else if (selection == 1) {
				cm.dispose();
				cm.openNpc(1002005, 2)

			} else if (selection == 2) {
				cm.dispose();
				cm.openNpc(1002005, 3)
				
			} else if (selection == 3) {
				cm.dispose();
				cm.openNpc(1002005,4)
				
		    } else if (selection == 4) {
				cm.dispose();
				cm.openNpc(1002005, 5)
				
			} else if (selection == 5) {
				cm.dispose();
				cm.openNpc(1002005, 6)
