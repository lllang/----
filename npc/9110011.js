...
var sss ="#fUI/UIWindow.img/QuestIcon/3/0#";
	...
	if (status == 0) {
	    ...
	    var textz = "\r\n勇士:#d#h ##k，每次使用#v4032766#一个，5000点券可召唤福袋。\r\n注意：请联系GM关闭宠物吸取\r\n奖励：#v4170000# #v4031250# #v4310071# #v4310070# #v4310038# #v4310080#  #v4310174#\r\n\r\n";

		textz += "#b#L0#解开封印【召唤--牛牛福袋】#l\r\n\r\n";
		
		textz += "#b#L1#解开封印【召唤--老虎福袋】#l\r\n\r\n";
	...
	if (selection == 0){
		...
		//}else if (cm.getMeso() >= 5000000) {	//&&cm.haveItem(4001257,1)&&cm.haveItem(4001258,1)&&cm.haveItem(4001259,1)&&cm.haveItem(4001260,1)// #i04001257# #i04001258# #i04001259# #i04001260#
                        ...
                        cm.dispose();
						cm.喇叭(2,"[牛年福袋]：玩家" + cm.getPlayer().getName() + "在自由市场召唤了牛年福袋~大家快来击杀");
		...
		//}else if (cm.getMeso() >= 5000000) {	//&&cm.haveItem(4001257,1)&&cm.haveItem(4001258,1)&&cm.haveItem(4001259,1)&&cm.haveItem(4001260,1)// #i04001257# #i04001258# #i04001259# #i04001260#
                        ...
                        cm.dispose();
						cm.喇叭(2,"[虎年福袋]：玩家" + cm.getPlayer().getName() + "在自由市场召唤了虎年福袋~大家快来击杀");	
}
    }else if (selection == 2){
		var party = cm.getPlayer().getParty();		
