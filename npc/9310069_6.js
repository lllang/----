...
[1902338,500,500,500,500,0,0,500,500,0,0,0,0,0,0,"全属性+500手套",88000],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		msg += "\t\t\t  #v2531006##e#r合 成 防 爆 中 心#k#n#v2531006#\r\n"
       ...
       if(cm.getInventory(1).isFull(1)){
		...
		cm.喇叭(1, "玩家【" + cm.getPlayer().getName() + "】转身100次成功兑换500属性坐骑！！！");
        cm.dispose();
    } else {
