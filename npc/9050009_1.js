...
text += "#L0#"+琴符+"爆肝神秘"+琴符+"#l       #L5#"+琴符+"爆肝暴君"+琴符+"#l\r\n\r\n"
//text += "#L4#"+琴符+"爆肝手套"+琴符+"#l       #L1#"+琴符+"爆肝鞋子"+琴符+"#l\r\n\r\n"
//text += "#L2#"+琴符+"超级爆肝"+琴符+"#l       \r\n\r\n"
...
text += "   "+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+琴符+圆形+"\r\n"	
			...
			if (selection == 0) {
				cm.dispose();
				cm.openNpc(9050009, 2)
		   } else if (selection == 1) {
				cm.dispose();
				cm.openNpc(2100000, 9)

			} else if (selection == 2) {
				cm.dispose();
				cm.openNpc(2100000, 3)
			} else if (selection == 3) {
				cm.dispose();
				...
				cm.dispose();
				cm.openNpc(9050009, 0)
			} else if (selection == 6) {
				cm.dispose();
				cm.openNpc(2100000, 5)
			} else if (selection == 5) {
				cm.dispose();
				cm.openNpc(9050009, 3)
			}
		}
	}
}
