...
function setup() {
    ...
    var map = eim.setInstanceMap(970030106);
    map.resetFully();
   // map.getPortal("next00").setScriptName("kpq1");
    map = eim.setInstanceMap(970030107);
    map.resetFully();
    map = eim.setInstanceMap(970030108);
    map.resetFully();
    map = eim.setInstanceMap(970030109);
    map.resetFully();
...
function playerEntry(eim, player) {
    var map = eim.getMapFactory().getMap(970030106);
...
function changedMap(eim, player, mapid) {
    switch (mapid) {
        case 970030106: // 1st Stage
        case 970030107: // 2nd Stage
        case 970030108: // 3rd Stage
        case 970030109: // 4th Stage
            return;
    }
