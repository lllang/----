...
function playerEntry(eim, player) {
    var buff = Array(2022090, 2022091, 2022092, 2022093);
    var buffSet;
    buffSet = buff;
    var map = eim.getMapInstance(0);
    player.changeMap(map, map.getPortal(0));
    var sel = Math.floor(Math.random() * buffSet.length);
    eim.applyBuff(player, buffSet[sel]);
